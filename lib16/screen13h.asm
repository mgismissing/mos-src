...
scr13_draw_dotted_line:                           ; scr13_draw_line(ax > Start, bx > End, dl > Color) => None
    cmp ax, bx
    jge scr13_global_ret
    call scr13_pixel_set
    add ax, 2
    jmp scr13_draw_dotted_line

scr13_draw_dotted_vertical_line:                  ; scr13_draw_vertical_line(ax > Start, bx > End, dl > Color) => None
    cmp ax, bx
    jge scr13_global_ret
    call scr13_pixel_set
    add ax, SCR13_WIDTH * 2
    jmp scr13_draw_dotted_vertical_line
...
scr13_print_string_x4:                            ; scr13_print_string_x4(ax > Index, bx > String Pointer, dl > Color) => None
    mov si, bx             ; Copy string pointer into si
